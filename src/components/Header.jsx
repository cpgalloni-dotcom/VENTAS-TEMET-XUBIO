...
import { ShieldCheck, Key, RefreshCw, Layers, Database } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <h1 className="text-xl font-bold tracking-tight text-white">TEMET</h1>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            onClick={onRefresh}
            disabled={loading}
            className="p-2 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-white transition-colors disabled:opacity-50 shadow-md shadow-cyan-600/20"
