...
const STORAGE_KEY_VENTAS = 'temet_real_ventas_store_v4';

// Registros de "Análisis de Facturas de Venta" exactos de Xubio para Temet INC SAS (Período 01-09-2026 a 20-09-2026)
...
export const xubioApi = {
  ...
  getStoredVentas() {
    ...
    // Inicializar almacenamiento con las 10 ventas exactas de Xubio
